...
public class SintacticJSON extends java_cup.runtime.lr_parser {
     ...
     */
    @Deprecated
    public SintacticJSON(java_cup.runtime.Scanner s) {
        super(s);
    }
     ...
     * Constructor which sets the default scanner.
     */
    public SintacticJSON(java_cup.runtime.Scanner s, java_cup.runtime.SymbolFactory sf) {
        super(s, sf);
    }
    ...
    public void syntax_error(Symbol cur_token) {
        if (cur_token.sym != symJSON.EOF) {
            ...
            expected_token_ids().forEach(token -> {
                expectedTkns.add(symJSON.terminalNames[(int) token]);
            });
            for (String expectedTkn : expectedTkns) {
                System.out.println(expectedTkn);
            }
            addError(cur_token);
        }
    }
